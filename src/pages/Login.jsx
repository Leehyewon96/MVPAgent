    ...
    <div className="min-h-screen flex items-center justify-center bg-dark-950 px-4">
      ...
      >
        <div className="card text-center">
          ...
          <h1 className="text-2xl font-bold mb-2">MVP Agent</h1>
          <p className="text-dark-400 mb-8">
            멀티 에이전트 게임 자동화 파이프라인
          </p>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white text-gray-800 font-medium px-6 py-3 rounded-xl hover:bg-gray-100 transition-all duration-200 active:scale-95 disabled:opacity-50"
          >
